...
\acro{GNSS}[GNSS]{Sistemas Globales de Navegación por Satélite}

\acro{GPS}[GPS]{Sistemas de Posicionamiento Global}

\acro{GIS}[GIS]{Sistemas de Información Geospacial}
